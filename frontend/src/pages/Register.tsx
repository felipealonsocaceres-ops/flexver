      ...
      >
        ...
        >
          ...
          <form onSubmit={handleRegister} className="space-y-4">
            ...
            <div>
              <label className="block text-sm font-medium text-slate-400 mb-1">Correo electronico</label>
              <div className="relative">
            ...
            <div>
              <label className="block text-sm font-medium text-slate-400 mb-1">Contrasena</label>
              <div className="relative">
            ...
            <div>
              ...
              <div className="grid grid-cols-2 gap-3 mt-1">
                <button
                  ...
                  className="py-3 rounded-lg border text-white font-medium transition-all text-sm flex items-center justify-center gap-2"
                >
